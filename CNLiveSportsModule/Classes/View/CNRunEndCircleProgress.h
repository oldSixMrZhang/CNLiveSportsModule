...
#import "CNRunEndCountingLabel.h"

#define CNCircleDegreeToRadian(d) ((d)*M_PI)/180.0
#define CNCircleRGB(r, g, b) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1.0]
#define CNCircleSelfWidth self.frame.size.width
#define CNCircleSelfHeight self.frame.size.height

@interface CNRunEndCircleProgress : UIView
...
@property (nonatomic, strong) CNRunEndCountingLabel *progressLabel;
